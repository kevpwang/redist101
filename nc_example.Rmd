...
We can use `comp_edge` to visualize the compactness of entire plans. Another option is to use `comp_polsby` to display the compactness of individual districts across plans.
...
We can also compare distributions of different summary statistics across districts. The following code plots the distribution of democratic percentage of each district for all simulations.
