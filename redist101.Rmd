...
This vignette introduces you to the redistricting analysis with algorithmic simulations--the state-of-art method to understand gerrymandering--with our `redist` package.
...
The first step one in a `redist` analysis is creating the `redist_map` object, which stores the basic parameters of the redistricting problem. Here, we use the `redist_map` objects that can be downloaded from `alarmdata` package.
